...
---           `yaal' (c) 1978 by Marcin 'Amok' Konarski            ---
	...
	sqlite_driver.cxx - this file is integral part of `yaal' project.
...
int yaal_sqlite_driver_main( int, char** ) __attribute__(( __noreturn__ ));
int yaal_sqlite_driver_main( int, char** )
	{
	::exit( 0 );
	}
