...
if ( CMAKE_HOST_WIN32 )
	if ( IS_DIRECTORY "_deploy/freebsd" )
		set( CPACK_PACKAGE_DESCRIPTION_FILE "_deploy/freebsd/pkg-descr")
	endif()
	if ( EXISTS "doc/COPYRIGHT" )
		configure_file( "./doc/COPYRIGHT" "./build/COPYRIGHT.txt" COPYONLY )
		set( CPACK_RESOURCE_FILE_LICENSE "build/COPYRIGHT.txt" )
	endif()
