...
if ( NOT CMAKE_HOST_WIN32 )
	...
	if ( "x${UNAME_OS_NAME}" STREQUAL "xLinux" )
		...
		if ( HAVE_LSB_RELEASE )
			execute_process( COMMAND lsb_release -si OUTPUT_VARIABLE HOST_OS_TYPE OUTPUT_STRIP_TRAILING_WHITESPACE )
		...
		if ( "x${HOST_OS_TYPE}" STREQUAL "xFreeBSD" )
			...
			set( HOST_INFO "${UNAME_OS_NAME} ${HOST_INFO}" )
	...
	execute_process( COMMAND systeminfo COMMAND findstr /B /C:"OS Name" OUTPUT_VARIABLE HOST_INFO_HEAD OUTPUT_STRIP_TRAILING_WHITESPACE )
	execute_process( COMMAND systeminfo COMMAND findstr /B /C:"OS Version" OUTPUT_VARIABLE HOST_INFO_TAIL OUTPUT_STRIP_TRAILING_WHITESPACE )
	set( HOST_INFO "${HOST_INFO_HEAD} ${HOST_INFO_TAIL}" )
endif()
