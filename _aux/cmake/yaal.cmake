...
function( yaal_make_component name )
	...
	if ( CMAKE_HOST_WIN32 )
		...
		target_include_directories( ${name} PRIVATE "${CMAKE_HOME_DIRECTORY}/_aux/msvcxx" )
		target_include_directories( ${name}-static PRIVATE "${CMAKE_HOME_DIRECTORY}/_aux/msvcxx" )
...
if ( CMAKE_HOST_WIN32 )
	...
	target_link_libraries( hcore msvcxx libintl pthreadVCE2d libeay32 ssleay32 Dbghelp regex libgcc Ws2_32 Psapi )
	target_link_libraries( tools hcore libxml2 libxslt libexslt zlib iconv libintl Ws2_32 )
