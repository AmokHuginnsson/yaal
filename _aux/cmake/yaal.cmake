...
if ( CMAKE_HOST_WIN32 )
	...
	target_link_libraries( tools hcore libxml2 libxslt libexslt yaml zlib libintl Ws2_32 )
	...
	target_compile_definitions( tools PRIVATE YAML_DECLARE_STATIC=1 )
	...
	target_link_libraries( tools hcore ${LIBXML2_LIBRARIES} ${LIBXSLT_LIBRARIES} exslt yaml dl z )
	target_link_libraries( dbwrapper tools hcore )
