...
ifdef DO_RELEASE
	...
	LINKER_OPTIMIZATION_FLAGS = $(EXTRA_LINKER_OPTIMIZATION_FLAGS)
	LIB_INFIX =
endif
ifdef DO_RELDEB
	TARGET=reldeb
...
override LXXFLAGS = $(strip $(LIBRARY_PATHS) \
	$(LINKER_OPTIMIZATION_FLAGS) $(LINKER_DEBUG_FLAGS) \
	$(LINKER_PROFILING_FLAGS) $(LINKER_COVERAGE_FLAGS) \
	$(LDFLAGS) $(LINKER_PRIME_FLAGS) \
	$(EXTRA_LXXFLAGS))
