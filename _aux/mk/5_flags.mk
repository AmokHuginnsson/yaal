...
COMPILER_PRIME_FLAGS = -fmessage-length=0 -std=$(CXX_STANDARD) -Wno-long-long -Wno-variadic-macros -Wno-invalid-source-encoding -pipe -D_GNU_SOURCE -D_REENTRANT -D_THREAD_SAFE -D_POSIX_PTHREAD_SEMANTICS
...
override CPLUS_INCLUDE_PATH := /usr/include:${CPLUS_INCLUDE_PATH}
