...
mrproper-$(1): clean-$(1)
	@$$(if $$(wildcard $$(realpath build/$(1))*), $$(MAKE) -C build/$(1) -f Makefile.mk -e mrproper && cd - && cd build && /bin/rm -rf $(1))

clean-$(1):
	@$$(if $$(wildcard $$(realpath build/$(1))*), $$(MAKE) -C build/$(1) -f Makefile.mk -e clean)
