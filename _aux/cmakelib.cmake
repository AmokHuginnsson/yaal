...
macro (today RESULT)
	if (WIN32)
		execute_process( COMMAND cmd /C wmic os get LocalDateTime OUTPUT_VARIABLE ${RESULT} )
		string( REPLACE "LocalDateTime" "" ${RESULT} ${${RESULT}} )
		string( REPLACE "\r\n" "" ${RESULT} ${${RESULT}} )
		string( REPLACE " " "" ${RESULT} ${${RESULT}} )
		string( SUBSTRING ${${RESULT}} 0 8 ${RESULT} )
	elseif(UNIX)
