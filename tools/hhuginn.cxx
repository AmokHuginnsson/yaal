...
HHuginn::identifier_id_t const TYPE_NONE_IDENTIFIER( 50 );
HHuginn::identifier_id_t const TYPE_OBSERVER_IDENTIFIER( 51 );
HHuginn::identifier_id_t const TYPE_REFERENCE_IDENTIFIER( 52 );
HHuginn::identifier_id_t const TYPE_FUNCTION_REFERENCE_IDENTIFIER( 53 );
HHuginn::identifier_id_t const TYPE_OBJECT_REFERENCE_IDENTIFIER( 54 );
HHuginn::identifier_id_t const TYPE_METHOD_IDENTIFIER( 55 );
HHuginn::identifier_id_t const TYPE_BOUND_METHOD_IDENTIFIER( 56 );
HHuginn::identifier_id_t const TYPE_VARIADIC_PARAMETERS_IDENTIFIER( 57 );
HHuginn::identifier_id_t const TYPE_NAMED_PARAMETERS_IDENTIFIER( 58 );
HHuginn::identifier_id_t const TYPE_UNKNOWN_IDENTIFIER( 59 );
