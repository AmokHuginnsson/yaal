...
HRuntime::HRuntime( HHuginn* huginn_ )
	...
	, _identifierIds( {
			...
			{ BUILTIN::TYPE_PARTIAL, IDENTIFIER::BUILTIN::TYPE_PARTIAL },
...
void HRuntime::register_builtins( void ) {
	...
	M_ENSURE( ( identifier_id( BUILTIN::TYPE_PARTIAL ) == IDENTIFIER::BUILTIN::TYPE_PARTIAL ) && ( identifier_name( IDENTIFIER::BUILTIN::TYPE_PARTIAL ) == BUILTIN::TYPE_PARTIAL ) );
