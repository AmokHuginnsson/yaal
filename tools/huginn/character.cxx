	...
	HHuginn::class_t c(
		make_pointer<HHuginn::HClass>(
			...
			HHuginn::field_definitions_t{
				...
				{ "is_xdigit", make_pointer<HHuginn::HClass::HMethod>( hcore::call( &character::is_of_a_kind, "character.is_xdigit", static_cast<int(*)(int)>( ::std::isxdigit ), _1, _2, _3, _4 ) ), "tell if this character represents a hexadecimal digit" },
				{ "is_space",  make_pointer<HHuginn::HClass::HMethod>( hcore::call( &character::is_of_a_kind, "character.is_space", static_cast<int(*)(int)>( ::std::isspace ), _1, _2, _3, _4 ) ), "tell if this character represents a white space character" },
				{ "is_alpha",  make_pointer<HHuginn::HClass::HMethod>( hcore::call( &character::is_of_a_kind, "character.is_alpha", static_cast<int(*)(int)>( ::std::isalpha ), _1, _2, _3, _4 ) ), "tell if this character represents an alphabet character" },
