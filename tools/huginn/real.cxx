...
---           `yaal' 0.0.0 (c) 1978 by Marcin 'Amok' Konarski            ---
  ...
  real.cxx - this file is integral part of `yaal' project.
...
HHuginn::class_t get_class( HRuntime* runtime_ ) {
	...
	HHuginn::class_t c(
		make_pointer<HHuginn::HClass>(
			...
			"It supports basic operations of addition, substraction, multiplication, division, modulo, power and comparisons, "
