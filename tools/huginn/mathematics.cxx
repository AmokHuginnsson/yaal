	...
	HHuginn::class_t c(
		runtime_->create_class(
			...
			HHuginn::field_definitions_t{
				{ "pi",                   runtime_->object_factory()->create_method( hcore::call( &HMathematics::pi, _1, _2, _3, _4 ) ),                   "( *type* [, *precision*] ) - get value of $\\pi$ of type *type*, potentially with given *precision*" },
				{ "e",                    runtime_->object_factory()->create_method( hcore::call( &HMathematics::e, _1, _2, _3, _4 ) ),                    "( *type* [, *precision*] ) - get value of $e$ of type *type*, potentially with given *precision*" },
				{ "square_root",          runtime_->object_factory()->create_method( hcore::call( &HMathematics::square_root, _1, _2, _3, _4 ) ),          "( *value* ) - calculate square root of given *value*" },
				{ "natural_exponential",  runtime_->object_factory()->create_method( hcore::call( &HMathematics::natural_exponential, _1, _2, _3, _4 ) ),  "( *x* ) - calculate value of $e^x$ (value of natural exponential of *x*)" },
				{ "natural_logarithm",    runtime_->object_factory()->create_method( hcore::call( &HMathematics::natural_logarithm, _1, _2, _3, _4 ) ),    "( *x* ) - find natural logarithm of value *x*" },
				{ "sinus",                runtime_->object_factory()->create_method( hcore::call( &HMathematics::sinus, _1, _2, _3, _4 ) ),                "( *arg* ) - calculate value of *sine* function of *arg* argument" },
				{ "cosinus",              runtime_->object_factory()->create_method( hcore::call( &HMathematics::cosinus, _1, _2, _3, _4 ) ),              "( *arg* ) - calculate value of *cosine* function of *arg* argument" },
				{ "tangens",              runtime_->object_factory()->create_method( hcore::call( &HMathematics::tangens, _1, _2, _3, _4 ) ),              "( *arg* ) - calculate value of *tangent* function of *arg* argument" },
				{ "cotangens",            runtime_->object_factory()->create_method( hcore::call( &HMathematics::cotangens, _1, _2, _3, _4 ) ),            "( *arg* ) - calculate value of *cotangent* function of *arg* argument" },
				{ "arcus_sinus",          runtime_->object_factory()->create_method( hcore::call( &HMathematics::arcus_sinus, _1, _2, _3, _4 ) ),          "( *arg* ) - calculate value of *arcus sine* function of *arg* argument" },
				{ "arcus_cosinus",        runtime_->object_factory()->create_method( hcore::call( &HMathematics::arcus_cosinus, _1, _2, _3, _4 ) ),        "( *arg* ) - calculate value of *arcus cosine* function of *arg* argument" },
				{ "arcus_tangens",        runtime_->object_factory()->create_method( hcore::call( &HMathematics::arcus_tangens, _1, _2, _3, _4 ) ),        "( *arg* ) - calculate value of *arcus tangent* function of *arg* argument" },
				{ "arcus_cotangens",      runtime_->object_factory()->create_method( hcore::call( &HMathematics::arcus_cotangens, _1, _2, _3, _4 ) ),      "( *arg* ) - calculate value of *arcus cotangent* function of *arg* argument" },
				{ "hyperbolic_sinus",     runtime_->object_factory()->create_method( hcore::call( &HMathematics::hyperbolic_sinus, _1, _2, _3, _4 ) ),     "( *arg* ) - calculate value of *hyperbolic sine* function of *arg* argument" },
				{ "hyperbolic_cosinus",   runtime_->object_factory()->create_method( hcore::call( &HMathematics::hyperbolic_cosinus, _1, _2, _3, _4 ) ),   "( *arg* ) - calculate value of *hyperbolic cosine* function of *arg* argument" },
				{ "hyperbolic_tangens",   runtime_->object_factory()->create_method( hcore::call( &HMathematics::hyperbolic_tangens, _1, _2, _3, _4 ) ),   "( *arg* ) - calculate value of *hyperbolic tangent* function of *arg* argument" },
				{ "hyperbolic_cotangens", runtime_->object_factory()->create_method( hcore::call( &HMathematics::hyperbolic_cotangens, _1, _2, _3, _4 ) ), "( *arg* ) - calculate value of *hyperbolic cotangent* function of *arg* argument" },
				{ "sigmoid",              runtime_->object_factory()->create_method( hcore::call( &HMathematics::sigmoid, _1, _2, _3, _4 ) ),              "( *arg* ) - calculate value of *sigmoid* function of *arg* argument" },
				{ "error_function",       runtime_->object_factory()->create_method( hcore::call( &HMathematics::error_function, _1, _2, _3, _4 ) ),       "( *arg* ) - calculate value of *(Gaussian) error function* of *arg* argument" },
				{ "cumulative_distribution_function",
					runtime_->object_factory()->create_method( hcore::call( &HMathematics::cumulative_distribution_function, _1, _2, _3, _4 ) ),
				...
				{ "round",                runtime_->object_factory()->create_method( hcore::call( &HMathematics::round, _1, _2, _3, _4 ) ),                "( *value*[, *precision*] ) - round *value*, potentially to given *precision*" },
