...
class HChain : public HHuginn::HIterable {
	HHuginn::values_t _source;
public:
	HChain( HHuginn::HClass const* class_, HHuginn::values_t const& source_ )
		: HIterable( class_ )
		, _source( source_ ) {
	}
	HChain( HHuginn::HClass const* class_, HHuginn::values_t&& source_ )
		: HIterable( class_ )
