...
HHuginn::value_t HTime::to_string( huginn::HThread*, HHuginn::HObject* object_, HHuginn::values_t const& values_, int position_ ) {
	M_PROLOG
	char const name[] = "Time.to_string";
	verify_arg_count( name, values_, 0, 0, position_ );
	huginn::HTime* t( static_cast<huginn::HTime*>( object_ ) );
	return ( make_pointer<HHuginn::HString>( t->_time.to_string() ) );
	M_EPILOG
}
