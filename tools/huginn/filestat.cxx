...
HHuginn::value_t HFileStat::get_times( char const* name_, time_getter_t timeGetter_, huginn::HThread* thread_, HHuginn::value_t* object_, HHuginn::values_t const& values_, int position_ ) {
	...
	HHuginn::value_t v( thread_->runtime().none_value() );
	try {
		v = make_pointer<huginn::HTime>( o->_timeClass, (fi.*timeGetter_)() );
	} catch ( HFSItemException const& e ) {
		thread_->raise( o->_exceptionClass, e.what(), position_ );
	}
	return ( v );
	...
	HHuginn::class_t c(
		runtime_->create_class(
			...
			HHuginn::field_definitions_t{
				{ "id",       make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::id, _1, _2, _3, _4 ) ),    "get file's identification number" },
				{ "name",     make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::name, _1, _2, _3, _4 ) ),  "get the name of the file" },
				{ "size",     make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::size, _1, _2, _3, _4 ) ),  "get file size in bytes" },
				{ "mode",     make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::mode, _1, _2, _3, _4 ) ),  "get file's access permissions" },
				{ "type",     make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::type, _1, _2, _3, _4 ) ),  "get the type of the file" },
				{ "user",     make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::user, _1, _2, _3, _4 ) ),  "get an user name of the file owner" },
				{ "group",    make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::group, _1, _2, _3, _4 ) ), "get a group name of the file owner" },
				{ "created",  make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::get_times, "created",  &HFSItem::created, _1, _2, _3, _4 ) ),  "get file's metadata modification `time`" },
				{ "changed",  make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HFileStat::get_times, "changed",  &HFSItem::created, _1, _2, _3, _4 ) ),  "get file's metadata modification `time`" },
...
HHuginn::value_t HFileStat::do_clone( huginn::HRuntime* ) const {
