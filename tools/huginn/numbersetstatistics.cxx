	...
	HHuginn::class_t c(
		runtime_->create_class(
			...
			HHuginn::field_definitions_t{
				{ "minimum",                       make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "minimum",                       AGGREGATE_TYPE::MINIMUM, _1, _2, _3, _4 ) ), "a minimum numeric value in set" },
				{ "maximum",                       make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "maximum",                       AGGREGATE_TYPE::MAXIMUM, _1, _2, _3, _4 ) ), "a maximum numeric value in set" },
				{ "sum",                           make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "sum",                           AGGREGATE_TYPE::SUM, _1, _2, _3, _4 ) ), "a sum of all values in set" },
				{ "average",                       make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "average",                       AGGREGATE_TYPE::AVERAGE, _1, _2, _3, _4 ) ), "an average value of all numbers in set" },
				{ "median",                        make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "median",                        AGGREGATE_TYPE::MEDIAN, _1, _2, _3, _4 ) ), "a median value in set" },
				{ "variance",                      make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "variance",                      AGGREGATE_TYPE::VARIANCE, _1, _2, _3, _4 ) ), "a variance of the set" },
				{ "population_variance",           make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "population_variance",           AGGREGATE_TYPE::POPULATION_VARIANCE, _1, _2, _3, _4 ) ), "a population variance of the numeric set" },
				{ "standard_deviation",            make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "standard_deviation",            AGGREGATE_TYPE::STANDARD_DEVIATION, _1, _2, _3, _4 ) ), "a standard deviation of the numeric set" },
				{ "population_standard_deviation", make_pointer<HHuginn::HClass::HMethod>( hcore::call( &HNumberSetStatistics::stat, "population_standard_deviation", AGGREGATE_TYPE::POPULATION_STANDARD_DEVIATION, _1, _2, _3, _4 ) ), "a population standard deviation of the numeric set" }
			},
