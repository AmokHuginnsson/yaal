...
char const* near_keys( char key_ ) {
	...
	switch ( key_ ) {
		case ( '`' ):  near = "1\t";       break;
		case ( '1' ):  near = "`2q\t";     break;
		case ( '2' ):  near = "31wq";      break;
		case ( '3' ):  near = "42ew";      break;
		case ( '4' ):  near = "53re";      break;
		case ( '5' ):  near = "64tr";      break;
		case ( '6' ):  near = "75yt";      break;
		case ( '7' ):  near = "86uy";      break;
		case ( '8' ):  near = "97iu";      break;
		case ( '9' ):  near = "08oi";      break;
		case ( '0' ):  near = "9-po";      break;
		case ( '-' ):  near = "0=[p";      break;
		case ( '=' ):  near = "-\b][";     break;
		case ( '\b' ): near = "\n]=";      break;
		case ( '\t' ): near = "`1q";       break;
