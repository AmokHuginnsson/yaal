...
BuildRequires: make, autoconf, libtool, pkgconf-pkg-config, pcre-devel, libxml2-devel, libxslt-devel, libyaml-devel, zlib-devel, openssl-devel, ncurses-devel, doxygen, graphviz, rubygem-asciidoctor
Requires: pcre, libxml2, libxslt, libyaml, openssl, zlib, ncurses
