...
BuildRequires: make, autoconf, libtool, pkgconf-pkg-config, pcre-devel, libxml2-devel, libxslt-devel, zlib-devel, openssl-devel, ncurses-devel, doxygen, graphviz, rubygem-asciidoctor
