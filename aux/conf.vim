...
syn keyword stdhapiKeyword log_mask esc_delay disable_XON use_mouse latency command_compose_character command_compose_delay attribute_disabled attribute_enabled attribute_focused attribute_statusbar attribute_search_highlight ignore_signal_SIGINT ignore_signal_SIGTSTP ignore_signal_SIGQUIT serial_device serial_baudrate collector_connection_timeout data_base_driver
