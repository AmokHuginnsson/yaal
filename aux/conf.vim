...
syn keyword stdhapiValues true false on off yes no LOG_DEBUG LOG_INFO LOG_NOTICE LOG_WARNING LOG_ERROR LOG_CVSHEADER LOG_SQL BRIGHTMAGENTA MySQL PostgreSQL SQLite null none
syn keyword stdhapiKeyword log_mask esc_delay disable_XON use_mouse latency command_compose_character command_compose_delay disabled_attribute enabled_attribute focused_attribute statusbar_attribute ignore_signal_SIGINT ignore_signal_SIGTSTP ignore_signal_SIGQUIT serial_device serial_baudrate collector_connection_timeout data_base_driver mysql_socket
