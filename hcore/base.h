...
#define M_ENSURE( condition ) { if ( ! ( condition ) ){ yaal::hcore::HExceptionT<self_t> e( __FILE__, __PRETTY_FUNCTION__, __LINE__, #condition, errno ); e.set( strerror( errno ) ); throw e; } }
#ifndef NDEBUG
