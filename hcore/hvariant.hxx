...
void HVariant<t0_t, t1_t, t2_t, t3_t, t4_t, t5_t, t6_t, t7_t, t8_t, t9_t, t10_t, t11_t, t12_t, t13_t, t14_t, t15_t, t16_t, t17_t, t18_t, t19_t, t20_t>::destroy( int type_, void* mem_ )
	...
	try
		...
		kill_inferior( ( __FILE__ ":" M_STRINGIFY( __LINE__ ) ": destructor of `" + yaal::hcore::type_name<this_type>() + "[" + type_ + "]' throws `" + e.what() + "' in `" + __PRETTY_FUNCTION__ + "'." ).raw() );
		}
	catch ( ... )
		{
		kill_inferior( ( __FILE__ ":" M_STRINGIFY( __LINE__ ) ": destructor of `" + yaal::hcore::type_name<this_type>() + "[" + type_ + "]' throws in `" + __PRETTY_FUNCTION__ + "'." ).raw() );
		}
	}
