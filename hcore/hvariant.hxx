...
void HVariant<
	...
	t8_t, t9_t, t10_t, t11_t, t12_t, t13_t, t14_t, t15_t,
	t16_t, t17_t, t18_t, t19_t, t20_t
>::default_construct( int type_, void* mem_ ) {
	switch ( type_ ) {
		case ( -1 ): break;
...
>::destroy( int type_, void* mem_ ) {
	try {
		...
		kill_interior( ( __FILE__ ":" M_STRINGIFY( __LINE__ ) ": destructor of `" + yaal::hcore::type_name<this_type>() + "[" + type_ + "]' throws in `" + __PRETTY_FUNCTION__ + "'." ).raw() );
	}
}
...
void HVariant<
	...
	t8_t, t9_t, t10_t, t11_t, t12_t, t13_t, t14_t, t15_t,
	t16_t, t17_t, t18_t, t19_t, t20_t
>::swap( int type_, void* a_, void* b_ ) {
	using yaal::swap;
	switch ( type_ ) {
		case ( -1 ): break;
