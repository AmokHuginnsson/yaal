...
double long const PI( 3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798214808651328230664709384L );
double long const E( 2.71828182845904523536028747135266249775724709369995957496696762772407663035354759457138217852516642742746639193200305992181741L );
double long const INFINITY( bit_cast<double>( 0x7FF0000000000000 ) );
double long const NAN( bit_cast<double>( 0x7FF8000000000000 ) );
